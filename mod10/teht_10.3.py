...
class Building:
    ...
    def fire_alarm(self):
        ...
        for i in range(0, self.elevators_amount - 1):
            print("Fire alarm, all elevators going to bottom floor")

            print(f"Elevator {i + 1} started going to bottom floor")
            self.elevators[i].go_to_floor(self.min_floor)
